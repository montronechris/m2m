...
import { Plus, Info, Leaf, WheatOff, Loader2 } from "lucide-react";
...
export function MenuItemCard({ item, onAdd, isLoadingOptions = false }: MenuItemCardProps) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-md border-2 border-gray-200 hover:border-green-400 hover:shadow-xl hover:shadow-green-500/10 transition-all duration-300 hover:-translate-y-1 group">
      <div className="flex justify-between items-start gap-4">
        ...
        <Button
          ...
          className="bg-gray-900 text-white p-3 rounded-full hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-green-500/30 flex-shrink-0 group-hover:scale-110 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {isLoadingOptions ? (
