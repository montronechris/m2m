// src/app/register/titolare/page.tsx
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-green-50/30 p-4">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center space-y-6 border border-gray-100">
          ...
          <p className="text-gray-600">
            Benvenuto in TavolaRapida. Reindirizzamento al login...
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-green-50/30 p-4">
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Crea il tuo account Titolare</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-green-600">
